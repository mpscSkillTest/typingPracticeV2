...
const LessonPage = () => {
    ...
    return (
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Icons.Info
              className="cursor-pointer h-5 w-5 text-muted-foreground hover:text-primary "
  ...
  return (
    <Card className="h-full border-none outline-none">
      <CardHeader>
        <CardTitle className="text-xl flex items-center justify-between px-1 font-semibold">
